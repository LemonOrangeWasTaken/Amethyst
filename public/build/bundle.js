...
var app = (function () {
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "svelte-rg4gg4");
    			add_location(img, file$c, 30, 16, 1211);
    			attr_dev(div, "class", "toggle-element svelte-rg4gg4");
    			set_style(div, "width", /*containerWidth*/ ctx[1] / /*elements*/ ctx[0].length + "px");
    			add_location(div, file$c, 29, 12, 1066);
    		},
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (!src_url_equal(img.src, img_src_value = /*ele*/ ctx[12].iconDir)) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", img_alt_value = /*ele*/ ctx[12].alt);
    			attr_dev(img, "class", "selected svelte-rg4gg4");
    			add_location(img, file$c, 26, 16, 964);
    			attr_dev(div, "class", "toggle-element svelte-rg4gg4");
    			set_style(div, "width", /*containerWidth*/ ctx[1] / /*elements*/ ctx[0].length + "px");
    			add_location(div, file$c, 25, 12, 836);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, img);
    ...
    function create_each_block$1(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*$store*/ ctx[6] === /*ele*/ ctx[12].storeIdentifier) return create_if_block$3;
    ...
    function create_fragment$c(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			div = element("div");
    			attr_dev(div, "class", "selector svelte-rg4gg4");
    			set_style(div, "width", /*containerWidth*/ ctx[1] / /*elements*/ ctx[0].length + "px");
    			add_location(div, file$c, 36, 4, 1325);
    			set_style(main, "width", /*containerWidth*/ ctx[1] + "px");
    			attr_dev(main, "class", "svelte-rg4gg4");
    			add_location(main, file$c, 21, 0, 611);
    		},
    ...
    class MultiToggle extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$c, create_fragment$c, safe_not_equal, { elements: 0, containerWidth: 1, store: 2 });
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$9, 27, 4, 962);
    			set_style(main, "width", /*currentWidth*/ ctx[1] + "px");
    			attr_dev(main, "class", "svelte-1uz0d8o");
    			add_location(main, file$9, 25, 0, 891);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$8, 34, 12, 1043);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			p.textContent = "Saved";
    			attr_dev(p, "class", "svelte-1iakpd8");
    			add_location(p, file$8, 30, 12, 961);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			p.textContent = "Saving to the cloud...";
    			attr_dev(p, "class", "svelte-1iakpd8");
    			add_location(p, file$8, 28, 12, 903);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$8, 24, 4, 564);
    			attr_dev(main, "class", "svelte-1iakpd8");
    			add_location(main, file$8, 23, 0, 553);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$7, 6, 4, 132);
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			img = element("img");
    			attr_dev(p, "class", "svelte-tb1s0b");
    			add_location(p, file$6, 4, 4, 121);
    			attr_dev(img, "class", "more-options svelte-tb1s0b");
    			if (!src_url_equal(img.src, img_src_value = "./assets/icons/chevron-down.svg")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "");
    			add_location(img, file$6, 8, 4, 191);
    			attr_dev(main, "title", "Canvas zoom");
    			attr_dev(main, "class", "svelte-tb1s0b");
    			add_location(main, file$6, 3, 0, 90);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$5, 25, 4, 713);
    			set_style(div, "width", "10px");
    			add_location(div, file$5, 37, 4, 1105);
    			attr_dev(main, "class", "svelte-1x7csmn");
    			add_location(main, file$5, 23, 0, 625);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			attr_dev(p, "id", "desc");
    			attr_dev(p, "class", "svelte-1qesm1c");
    			add_location(p, file$4, 7, 8, 199);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, t);
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(p, "id", "title");
    			attr_dev(p, "class", "svelte-1qesm1c");
    			add_location(p, file$4, 4, 4, 107);
    			attr_dev(main, "title", main_title_value = /*options*/ ctx[0].title);
    			attr_dev(main, "class", "svelte-1qesm1c");
    			add_location(main, file$4, 3, 0, 49);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$3, 29, 8, 920);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img0, file$3, 25, 4, 774);
    			...
    			add_location(img1, file$3, 26, 4, 809);
    			attr_dev(main, "title", /*alt*/ ctx[1]);
    			...
    			add_location(main, file$3, 23, 0, 584);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 63, 12, 2112);
    			attr_dev(section0, "class", "svelte-1fkryy");
    			add_location(section0, file$2, 61, 8, 1988);
    			attr_dev(section1, "id", "left-ctrl");
    			attr_dev(section1, "class", "svelte-1fkryy");
    			add_location(section1, file$2, 58, 4, 1722);
    			...
    			add_location(main, file$2, 56, 0, 1615);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
