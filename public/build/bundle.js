    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$c, 33, 12, 1280);
    			...
    			add_location(div, file$c, 32, 8, 1112);
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 63, 12, 2097);
    			attr_dev(section0, "class", "svelte-1fkryy");
    			add_location(section0, file$2, 61, 8, 1973);
    			attr_dev(section1, "id", "left-ctrl");
    			attr_dev(section1, "class", "svelte-1fkryy");
    			add_location(section1, file$2, 58, 4, 1707);
    			...
    			add_location(main, file$2, 56, 0, 1600);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
