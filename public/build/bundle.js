...
var app = (function () {
    ...
    const file$8 = "src/comp/controls/MultiToggle.svelte";
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$8, 26, 16, 964);
    			attr_dev(div, "class", "toggle-element svelte-jl85h2");
    			set_style(div, "width", /*containerWidth*/ ctx[1] / /*elements*/ ctx[0].length + "px");
    			add_location(div, file$8, 25, 12, 836);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, img);
    ...
    class MultiToggle extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$8, create_fragment$8, safe_not_equal, { elements: 0, containerWidth: 1, store: 2 });
    ...
    const file$7 = "src/comp/ctrlMenuItems/ViewSwitcher.svelte";
    ...
    const file$6 = "src/comp/ctrlMenus/LeftMenu.svelte";
    ...
    const file$5 = "src/comp/ctrlMenus/RightMenu.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$5, 28, 4, 1001);
    			set_style(main, "width", /*currentWidth*/ ctx[1] + "px");
    			attr_dev(main, "class", "svelte-1uz0d8o");
    			add_location(main, file$5, 26, 0, 930);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    					...
    					dragSpace.onmousedown = () => {
    						document.onmousemove = e => {
    							...
    							if (docWidth - e.clientX < 600 && docWidth - e.clientX > 200) {
    								$$invalidate(1, currentWidth = docWidth - e.clientX);
    								disp("widthChange", { width: currentWidth });
    							}
    						};
    					},
    ...
    const file$4 = "src/comp/ctrlMenuItems/FileNameEditor.svelte";

    // (36:8) {#if !$fileStat.saved}
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(p, "class", "svelte-101iqxf");
    			add_location(p, file$4, 36, 12, 1109);
    		},
    		m: function mount(target, anchor) {
    ...
    // (29:4) {#if $fileStat.alwaysShowSaveStatus}
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(29:4) {#if $fileStat.alwaysShowSaveStatus}",
    		ctx
    	});
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			p.textContent = "Saved";
    			attr_dev(p, "class", "svelte-101iqxf");
    			add_location(p, file$4, 32, 12, 1027);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			p.textContent = "Saving to the cloud...";
    			attr_dev(p, "class", "svelte-101iqxf");
    			add_location(p, file$4, 30, 12, 969);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "svelte-101iqxf");
    			add_location(span, file$4, 24, 4, 564);
    			attr_dev(main, "class", "svelte-101iqxf");
    			add_location(main, file$4, 23, 0, 553);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class FileNameEditor extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { leftMenuWidth: 0, controlSectionWidth: 1 });
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = space();
    			img5 = element("img");
    			attr_dev(img0, "id", "pfp");
    			if (!src_url_equal(img0.src, img0_src_value = "./assets/pngs/testpfp.png")) attr_dev(img0, "src", img0_src_value);
    			attr_dev(img0, "alt", "");
    			attr_dev(img0, "class", "svelte-1ytymaz");
    			add_location(img0, file$3, 13, 4, 363);
    			if (!src_url_equal(img1.src, img1_src_value = "./assets/icons/share.svg")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "");
    			attr_dev(img1, "class", "svelte-1ytymaz");
    			add_location(img1, file$3, 17, 8, 479);
    			attr_dev(div0, "class", "app-ctrl-icons svelte-1ytymaz");
    			add_location(div0, file$3, 16, 4, 442);
    			if (!src_url_equal(img2.src, img2_src_value = "./assets/icons/checkmark-circle-2.svg")) attr_dev(img2, "src", img2_src_value);
    			attr_dev(img2, "alt", "");
    			attr_dev(img2, "class", "svelte-1ytymaz");
    			add_location(img2, file$3, 22, 8, 600);
    			attr_dev(div1, "class", "app-ctrl-icons svelte-1ytymaz");
    			add_location(div1, file$3, 21, 4, 563);
    			if (!src_url_equal(img3.src, img3_src_value = "./assets/icons/sun.svg")) attr_dev(img3, "src", img3_src_value);
    			attr_dev(img3, "alt", "");
    			attr_dev(img3, "class", "svelte-1ytymaz");
    			add_location(img3, file$3, 27, 8, 748);
    			attr_dev(div2, "class", "app-ctrl-icons svelte-1ytymaz");
    			add_location(div2, file$3, 26, 4, 711);
    			if (!src_url_equal(img4.src, img4_src_value = "./assets/icons/plus.svg")) attr_dev(img4, "src", img4_src_value);
    			attr_dev(img4, "alt", "");
    			attr_dev(img4, "class", "svelte-1ytymaz");
    			add_location(img4, file$3, 32, 8, 875);
    			attr_dev(img5, "class", "more-options svelte-1ytymaz");
    			if (!src_url_equal(img5.src, img5_src_value = "./assets/icons/chevron-down.svg")) attr_dev(img5, "src", img5_src_value);
    			attr_dev(img5, "alt", "");
    			add_location(img5, file$3, 33, 8, 926);
    			attr_dev(div3, "class", "app-ctrl-icons multi svelte-1ytymaz");
    			add_location(div3, file$3, 31, 4, 832);
    			attr_dev(main, "class", "svelte-1ytymaz");
    			add_location(main, file$3, 11, 0, 275);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
